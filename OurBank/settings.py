...
ALLOWED_HOSTS = ['ourbank1-fqaudgexeqgygxcy.brazilsouth-01.azurewebsites.net', 'localhost', '127.0.0.1', '169.254.129.4']
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://ourbank1-fqaudgexeqgygxcy.brazilsouth-01.azurewebsites.net'
]
